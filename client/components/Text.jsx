  ...
  class Text extends React.Component {
	...
	<div className='text-box'>
	  <div className='text-box_content'>
	    ...
	    <p className='text'><span className='te-reo'>{this.state.par.tereo}</span><span className='english'>{this.state.par.english}</span></p>
	    <div>
		...
		{(this.state.index < this.state.textLength) && <p onClick={()=>this.next()}>next</p>} 
	      </div>
	    </div>
	  </div>
	</div>
